> ⚠️ **本文档是历史留存，描述的是最初的设想，不是当前实现。**
>
> 其中若干说法与代码不符（例如"推荐CTR提升15%""P99<2s"——两者都无实测支撑；"三语言实现"——Java/Go 已删除；"MCP协议同步WMS"——二次开发前只是一句注释）。
>
> **当前真实状态请看** [docs/progress.md](progress.md)（进度总览）
> 与 [README.md](README.md) 顶部的「本文档里的数字哪些能信」一节。
